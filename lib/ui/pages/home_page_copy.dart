...
//   BlocBuilder<HomeBloc, HomeState> _lastHistoryBlocBuilder(
//     TextTheme textTheme,
//   ) {
...
//           lastHistory = state.history.last;
...
//   _orderHistoryTextHeader(TextTheme textTheme) {
//     return Padding(
...
//   _categoryTextHeader(TextTheme textTheme) {
//     return Padding(
//       padding: const EdgeInsets.symmetric(horizontal: 25),
//       child: Row(
//         mainAxisAlignment: MainAxisAlignment.spaceBetween,
