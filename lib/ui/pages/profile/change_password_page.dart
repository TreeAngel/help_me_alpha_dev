...
class ChangePasswordPage extends StatelessWidget {
  ...
  SizedBox _saveButton(
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        onPressed: () => context.read<ProfileCubit>().editPasswordSubmitted(),
      ),
    );
  }
  ...
  TextFormField _oldPasswordInputField(
    ...
    return TextFormField(
      onChanged: (value) => context.read<ProfileCubit>().oldPassword = value,
  ...
  TextFormField _newPasswordInputField(
      BuildContext context, TextTheme textTheme) {
    return TextFormField(
      onChanged: (value) => context.read<ProfileCubit>().newPassword = value,
      decoration: InputDecoration(
        filled: true,
        fillColor: Colors.white,
  ...
  TextFormField _newConfirmPasswordInputField(
    ...
    return TextFormField(
      onChanged: (value) =>
          context.read<ProfileCubit>().newConfirmPassword = value,
      decoration: InputDecoration(
        filled: true,
        fillColor: Colors.white,
