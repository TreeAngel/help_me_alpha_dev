class ProblemQuestions {
  ...
  static const List<String> kunciMotor = ['Biasa', 'Keyless'];
  ...
  static const List<String> kunciMobil = ['Biasa', 'Keyless'];
  ...
  static const List<String> kunciRumah = ['Kunci biasa', 'Kunci digital'];
  ...
  // Personal
  static const List<String> keseleo = ['Bayi', 'Anak-anak', 'Dewasa'];

  static const List<String> genderTerapis = ['Pria', 'Wanita'];
}
